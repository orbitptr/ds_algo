...
public class AmazonPQ_MaxSkill {
	/*
	...
	*/
	...
	public static int findMaxSkill(String[] input1,ArrayList<Worker> workerArrayList){
		int maxSkillCount=0;
		for(int i=0;i<input1.length;i++){
			...
			worker.skill--;
			//workerLinkedList.addLast(worker);
			workerArrayList.add(worker);
		}
		return maxSkillCount;
	}

	public static void analizeWorkerList(ArrayList<Worker> workerArrayList,ArrayList<MyBinaryHeap<Worker>> workers){		
	...
	public static void analizeJobsList(String[] input2,ArrayList<ArrayList<Job>> jobs){
		...
		for(int i=0;i<input2.length;i++){
			...
			job.skill = (int)Integer.parseInt(temp.substring(1,temp.length())); 
	...
	public static String[] warehouseScalability(String[] input1,String[] input2)
	{
		...
		analizeWorkerList(workerArrayList,workers);  //J*()
	...
	public static String[] generateOutputString(ArrayList<Worker> workerArrayList){
		ArrayList<String> output = new ArrayList<String>();
		for(Worker currentWoker : workerArrayList){
